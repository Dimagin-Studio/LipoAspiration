            ...
            >
              <div className="mb-4">
                {/* <img
								...
								/> */}
                <div className="w-24 h-24 rounded-full object-cover mx-auto border-4 border-white shadow-md flex items-center justify-center">
                  {testimonial.name.split(" ").map((word, i) => (
